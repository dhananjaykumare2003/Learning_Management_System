    ...
    <Card>
        <CardHeader className={"flex flex-row justify-between"}>
            ...
            <div className='space-x-2'>
                <Button variant={"outline"} disabled={courseByIdData?.course.lectures.length === 0} onClick={()=>publishStatusHandler(courseByIdData?.course.isPublished ? "false" : "true")}>{courseByIdData?.course.isPublished ? "Unpublished" : "Published"}</Button>
        ...
        <CardContent>
            <div className='space-y-4 mt-5'>
                ...
                <div>
                    ...
                    <Input type={"text"} name="description" value={input.description}  onChange={changeEventHandler} placeholder="Ex. Become a Fullstack developer from zero to hero in 2 months"></Input>
                </div>
                ...
                <div>
                    ...
                    <Input type={"file"} accept="image/*" onChange={selectThumbnail} className={"w-fit"}></Input>
                    {
                        previewThumbnail && (
